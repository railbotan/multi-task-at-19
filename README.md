...
* **150140 мс** на 84 ссылки
* Перепишите код, используя `ThreadPoolExecutor`. 
* **89000 мс** на 84 ссылки
* Изменяйте количество воркеров: 5, 10, 100.
**70100 мс** при 5 воркерах, **82000 мс** при 10 воркерах, **89000 мс** при 100 воркерах
...
* **Изменение кол-ва воркеров приводит к увеличению производительности и большему использованию сети**
...
* **162000 мс** на 3 монеты
* Ускорьтесь за счет использования `ProcessPoolExecutor`.
* **272000 мс** на 3 монеты
* Изменяйте количество воркеров: 2, 4, 5, 10, 100.
* **380000 мс - 2 воркера, 410000 мс - 4 воркера, 190000 мс - 10 воркеров, 230000мс - 100 воркеров**
* Во время работы посмотрите с использованием стандартных утилит вашей OC загрузку памяти, процессора, сети, время работы. Зависят ли они от количества воркеров и как?
* **Изменение количества воркеров существенно влияет на использование CPU и ОЗУ, увеличение производительности происходит, пока не будут использованы все ресурсы ПК.**
